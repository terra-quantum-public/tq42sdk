...
| `local_optimizer`                | URL     | This is the URL for the endpoint defining the local optimizer function.                                                                                                                                             | 
| `objective_function_channel_id ` | UUID    | This is the UUID for the channel created by using the connect API                                                                                                                                                   |
| `local_optimizer_channel_id`     | UUID    | This is the UUID for the channel created by using the connect API                                                                                                                                                   |
